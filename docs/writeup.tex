...
\textbf{G5} replaces the (KKT-certified) optimal achievable prior by its i.i.d.\
\emph{product} (marginalized) version and shows the marginalization cost. The
achievability-optimal prior is the KKT-certified march; the bound is the exact
random-coding kernel. G1 stays at $n=8$; G2--G5 are shown at $n=8$ and $n=20$.
(The converse prior is omitted from G5: its single-threshold optimum is non-unique
where the converse is slack, so reusing it for the whole-spectrum integral is
ill-posed.)
...
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g2_prior_gap_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g2_prior_gap_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G2 --- the prior gap (exact kernel). Right panels: gain of the optimal
prior over the best memoryless prior.}
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g3_bounds_vs_exact_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g3_bounds_vs_exact_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G3 --- exact random coding vs.\ the union bound.}
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g4_fcurve_compare_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g4_fcurve_compare_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G4 --- error spectrum of the achievability- vs.\ converse-optimal prior.}
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g5_full_vs_product_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{channel_g5_full_vs_product_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G5 --- the optimal achievable prior vs.\ its i.i.d.\ \emph{product}
(marginalized) version (left), and the marginalization cost (right): $\approx3.5\%$
at low rate, $\to 0$ at high rate. The optimum is nearly i.i.d.}
\end{figure}
\begin{figure}[H]\centering
...
blocklength. Converse (max rate with floor $\le\epsilon$) and achievable
($\Phi$-march bound $\le\epsilon$) bracket the $\epsilon$-capacity and rise toward
$C$. Each point is a bisection on $R$ (the bound is monotone in rate).}
\end{figure}
...
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g2_prior_gap_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g2_prior_gap_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G2 --- prior gap (exact best-of-$M$ kernel).}
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g3_bounds_vs_exact_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g3_bounds_vs_exact_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G3 --- exact random coding vs.\ the exponential surrogate.}
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g4_fcurve_compare_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g4_fcurve_compare_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G4 --- distortion spectra (nearly identical priors).}
\end{figure}
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g5_full_vs_product_n8.png}\caption{$n=8$}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_avg_g5_full_vs_product_n20.png}\caption{$n=20$}\end{subfigure}
\caption{G5 --- optimal achievable prior vs.\ its i.i.d.\ product: the
marginalization cost is $\approx6.5\%$; the optimum is still essentially i.i.d.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_exc_g1_mc_spread.png}\caption{G1}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_exc_g2_prior_gap.png}\caption{G2}\end{subfigure}
\\[4pt]
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_exc_g3_bounds_vs_exact.png}\caption{G3}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{rd_exc_g4_fcurve_compare.png}\caption{G4}\end{subfigure}
...
\end{figure}
\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{rd_exc_g5_full_vs_product.png}
\caption{G5 --- optimal achievable prior vs.\ its i.i.d.\ product: the
marginalization cost is $\approx8.6\%$ (largest of the three, a probability being
more prior-sensitive), but the optimum is still close to i.i.d.}
\end{figure}
